...
virtual Dynamic onWindowDeactivate_dyn()=0;
		virtual Void onWindowDropFile( ::lime::ui::Window window,::String file)=0;
virtual Dynamic onWindowDropFile_dyn()=0;
...
class IModule_delegate_ : public IModule_obj
{
	...
	public:
		...
		Void onWindowDropFile( ::lime::ui::Window window,::String file) { return mDelegate->onWindowDropFile(window,file);}
		Dynamic onWindowDropFile_dyn() { return mDelegate->onWindowDropFile_dyn();}
