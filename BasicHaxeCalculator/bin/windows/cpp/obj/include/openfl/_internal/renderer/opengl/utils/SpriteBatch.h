...
class HXCPP_CLASS_ATTRIBUTES  SpriteBatch_obj : public hx::Object{
	...
	public:
		...
		virtual Void renderBitmapData( ::openfl::display::BitmapData bitmapData,bool smoothing,::openfl::geom::Matrix matrix,::openfl::geom::ColorTransform ct,Dynamic alpha,Dynamic blendMode,::openfl::display::Shader flashShader,Dynamic pixelSnapping,hx::Null< bool >  bgra);
		...
		virtual Void fillVertices( int index,Float width,Float height,::openfl::geom::Matrix matrix,::openfl::display::TextureUvs uvs,hx::Null< int >  color,Dynamic pixelSnapping);
		...
		virtual Void setState( int index,::lime::graphics::opengl::GLTexture texture,Dynamic smooth,Dynamic blendMode,::openfl::geom::ColorTransform colorTransform,::openfl::display::Shader shader,Dynamic skipAlpha);
