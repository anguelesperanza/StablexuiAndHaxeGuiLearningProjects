...
class GraphicType_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		static ::openfl::_internal::renderer::opengl::utils::GraphicType DrawTriangles(Array< Float > vertices,Array< int > indices,Array< Float > uvtData,Dynamic culling,Array< int > colors,int blendMode);
