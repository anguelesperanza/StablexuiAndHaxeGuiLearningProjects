...
class HXCPP_CLASS_ATTRIBUTES  DrawTrianglesShader_obj : public ::openfl::_internal::renderer::opengl::shaders2::Shader_obj{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="openfl._internal.renderer.opengl.shaders2.DrawTrianglesShader")
		...
		::String __ToString() const { return HX_HCSTRING("DrawTrianglesShader","\x6c","\x2e","\x1c","\x23"); }
