...
class HXCPP_CLASS_ATTRIBUTES  GLBitmap_obj : public hx::Object{
	...
	public:
		...
		static Void drawBitmapDrawable( ::openfl::_internal::renderer::RenderSession renderSession,::openfl::display::BitmapData target,::openfl::display::IBitmapDrawable source,::openfl::geom::Matrix matrix,::openfl::geom::ColorTransform colorTransform,Dynamic blendMode,::openfl::geom::Rectangle clipRect);
