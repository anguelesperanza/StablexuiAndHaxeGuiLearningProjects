...
class HXCPP_CLASS_ATTRIBUTES  BitmapData_obj : public hx::Object{
	...
	public:
		...
		static ::openfl::display::BitmapData __asRenderTexture( hx::Null< int >  width,hx::Null< int >  height);
		...
		virtual Void __drawGL( ::openfl::_internal::renderer::RenderSession renderSession,::openfl::display::IBitmapDrawable source,::openfl::geom::Matrix matrix,::openfl::geom::ColorTransform colorTransform,Dynamic blendMode,::openfl::geom::Rectangle clipRect,Dynamic smoothing,Dynamic drawSelf,Dynamic clearBuffer,Dynamic readPixels,Dynamic powerOfTwo);
