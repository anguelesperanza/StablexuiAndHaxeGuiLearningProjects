...
class HXCPP_CLASS_ATTRIBUTES  IndexBuffer3D_obj : public hx::Object{
	public:
		...
		IndexBuffer3D_obj();
		Void __construct(::openfl::display3D::Context3D context,::lime::graphics::opengl::GLBuffer glBuffer,int numIndices,int bufferUsage);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="openfl.display3D.IndexBuffer3D")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		static hx::ObjectPtr< IndexBuffer3D_obj > __new(::openfl::display3D::Context3D context,::lime::graphics::opengl::GLBuffer glBuffer,int numIndices,int bufferUsage);
		...
		virtual Void uploadFromByteArray( ::openfl::utils::ByteArrayData byteArray,int byteArrayOffset,int startOffset,int count);
		...
		virtual Void uploadFromInt16Array( ::lime::utils::ArrayBufferView data);
