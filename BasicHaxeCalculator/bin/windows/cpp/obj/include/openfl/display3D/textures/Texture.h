...
class HXCPP_CLASS_ATTRIBUTES  Texture_obj : public ::openfl::display3D::textures::TextureBase_obj{
	...
	public:
		...
		static hx::ObjectPtr< Texture_obj > __new(::openfl::display3D::Context3D context,::lime::graphics::opengl::GLTexture glTexture,bool optimize,int width,int height);
		...
		virtual Void uploadFromUInt8Array( ::lime::utils::ArrayBufferView data,hx::Null< int >  miplevel);
