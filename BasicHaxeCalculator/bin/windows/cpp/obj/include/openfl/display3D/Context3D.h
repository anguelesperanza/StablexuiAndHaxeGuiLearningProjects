...
class HXCPP_CLASS_ATTRIBUTES  Context3D_obj : public hx::Object{
	...
	public:
		...
		virtual Void setGLSLProgramConstantsFromByteArray( ::String locationName,::openfl::utils::ByteArrayData data,hx::Null< int >  byteArrayOffset);
		...
		virtual Void setProgramConstantsFromByteArray( ::openfl::display3D::Context3DProgramType programType,int firstRegister,int numRegisters,::openfl::utils::ByteArrayData data,int byteArrayOffset);
