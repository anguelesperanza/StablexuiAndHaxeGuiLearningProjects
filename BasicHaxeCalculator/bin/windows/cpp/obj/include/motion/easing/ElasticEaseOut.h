...
class HXCPP_CLASS_ATTRIBUTES  ElasticEaseOut_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=false,const char *inName="motion.easing.ElasticEaseOut")
		...
		::String __ToString() const { return HX_HCSTRING("ElasticEaseOut","\x0b","\x44","\x9e","\xf0"); }
