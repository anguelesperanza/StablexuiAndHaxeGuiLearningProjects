...
Void NativeWindow_obj::create( ::lime::app::Application application){
{
		...
		if ((tmp2)){
			...
			HX_STACK_LINE(88)
			bool tmp34 = ::Reflect_obj::hasField(tmp33,HX_HCSTRING("resizable","\x6b","\x37","\x50","\xa9"));		HX_STACK_VAR(tmp34,"tmp34");
			HX_STACK_LINE(88)
			...
			if ((tmp34)){
				...
				HX_STACK_LINE(88)
				tmp35 = tmp37->config->__Field(HX_HCSTRING("resizable","\x6b","\x37","\x50","\xa9"), hx::paccDynamic );
			}
			else{
				HX_STACK_LINE(88)
				tmp35 = false;
			...
			HX_STACK_LINE(89)
			bool tmp39 = ::Reflect_obj::hasField(tmp38,HX_HCSTRING("stencilBuffer","\x1c","\x94","\x39","\x31"));		HX_STACK_VAR(tmp39,"tmp39");
			HX_STACK_LINE(89)
			...
			if ((tmp39)){
				...
				HX_STACK_LINE(89)
				tmp40 = tmp42->config->__Field(HX_HCSTRING("stencilBuffer","\x1c","\x94","\x39","\x31"), hx::paccDynamic );
			}
			else{
				HX_STACK_LINE(89)
				tmp40 = false;
			...
			HX_STACK_LINE(90)
			bool tmp44 = ::Reflect_obj::hasField(tmp43,HX_HCSTRING("vsync","\xd1","\x2d","\xa8","\x3d"));		HX_STACK_VAR(tmp44,"tmp44");
			HX_STACK_LINE(90)
			...
			if ((tmp44)){
				...
				HX_STACK_LINE(90)
				tmp45 = tmp47->config->__Field(HX_HCSTRING("vsync","\xd1","\x2d","\xa8","\x3d"), hx::paccDynamic );
			}
			else{
				HX_STACK_LINE(90)
				tmp45 = false;
			...
			HX_STACK_LINE(92)
			bool tmp48 = ::Reflect_obj::hasField(tmp47,HX_HCSTRING("title","\x98","\x15","\x3b","\x10"));		HX_STACK_VAR(tmp48,"tmp48");
			HX_STACK_LINE(92)
			if ((tmp48)){
				HX_STACK_LINE(94)
				::lime::ui::Window tmp49 = this->parent;		HX_STACK_VAR(tmp49,"tmp49");
				HX_STACK_LINE(94)
				::String tmp50 = tmp49->config->__Field(HX_HCSTRING("title","\x98","\x15","\x3b","\x10"), hx::paccDynamic );		HX_STACK_VAR(tmp50,"tmp50");
				HX_STACK_LINE(94)
				title = tmp50;
			}
		}
...
{
		HX_STACK_FRAME("lime._backend.native.NativeWindow","focus",0xe08a6f48,"lime._backend.native.NativeWindow.focus","lime/_backend/native/NativeWindow.hx",117,0x34b7ce9f)
		HX_STACK_THIS(this)
		HX_STACK_LINE(119)
		Dynamic tmp = this->handle;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(119)
...
{
		HX_STACK_FRAME("lime._backend.native.NativeWindow","move",0x8d1891a1,"lime._backend.native.NativeWindow.move","lime/_backend/native/NativeWindow.hx",164,0x34b7ce9f)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
		HX_STACK_LINE(166)
...
{
		HX_STACK_FRAME("lime._backend.native.NativeWindow","resize",0xad67cc84,"lime._backend.native.NativeWindow.resize","lime/_backend/native/NativeWindow.hx",177,0x34b7ce9f)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("lime._backend.native.NativeWindow","setIcon",0xb52ef3ab,"lime._backend.native.NativeWindow.setIcon","lime/_backend/native/NativeWindow.hx",245,0x34b7ce9f)
		HX_STACK_THIS(this)
