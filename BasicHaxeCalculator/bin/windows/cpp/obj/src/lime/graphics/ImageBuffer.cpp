...
{
HX_STACK_FRAME("lime.graphics.ImageBuffer","new",0xb261c9e3,"lime.graphics.ImageBuffer.new","lime/graphics/ImageBuffer.hx",43,0x6475c2cd)
HX_STACK_THIS(this)
...
::lime::graphics::ImageBuffer ImageBuffer_obj::clone( ){
	HX_STACK_FRAME("lime.graphics.ImageBuffer","clone",0x1504b3a0,"lime.graphics.ImageBuffer.clone","lime/graphics/ImageBuffer.hx",55,0x6475c2cd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(57)
