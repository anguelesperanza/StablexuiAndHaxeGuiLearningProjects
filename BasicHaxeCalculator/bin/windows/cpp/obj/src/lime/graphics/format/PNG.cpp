...
bool decodeData = __o_decodeData.Default(true);
	HX_STACK_FRAME("lime.graphics.format.PNG","decodeBytes",0x72bcffab,"lime.graphics.format.PNG.decodeBytes","lime/graphics/format/PNG.hx",30,0x0cfd2463)
...
bool decodeData = __o_decodeData.Default(true);
	HX_STACK_FRAME("lime.graphics.format.PNG","decodeFile",0xa9917f3c,"lime.graphics.format.PNG.decodeFile","lime/graphics/format/PNG.hx",51,0x0cfd2463)
...
::haxe::io::Bytes PNG_obj::encode( ::lime::graphics::Image image){
	HX_STACK_FRAME("lime.graphics.format.PNG","encode",0x30ec4988,"lime.graphics.format.PNG.encode","lime/graphics/format/PNG.hx",72,0x0cfd2463)
...
Dynamic PNG_obj::lime_png_decode_bytes( Dynamic data,bool decodeData){
	HX_STACK_FRAME("lime.graphics.format.PNG","lime_png_decode_bytes",0x29fbec68,"lime.graphics.format.PNG.lime_png_decode_bytes","lime/graphics/format/PNG.hx",172,0x0cfd2463)
...
Dynamic PNG_obj::lime_png_decode_file( ::String path,bool decodeData){
	HX_STACK_FRAME("lime.graphics.format.PNG","lime_png_decode_file",0x7595391f,"lime.graphics.format.PNG.lime_png_decode_file","lime/graphics/format/PNG.hx",173,0x0cfd2463)
	HX_STACK_ARG(path,"path")
	HX_STACK_ARG(decodeData,"decodeData")
	HX_STACK_LINE(173)
...
Dynamic PNG_obj::lime_image_encode( Dynamic data,int type,int quality){
	HX_STACK_FRAME("lime.graphics.format.PNG","lime_image_encode",0x87db2232,"lime.graphics.format.PNG.lime_image_encode","lime/graphics/format/PNG.hx",174,0x0cfd2463)
	HX_STACK_ARG(data,"data")
