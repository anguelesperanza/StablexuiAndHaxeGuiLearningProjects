...
Void Application_obj::createWindow( ::lime::ui::Window window){
{
		...
		HX_STACK_LINE(194)
		{
			...
			int __ArgCount() const { return 1; }
			Void run(::String a2){
				HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","lime/app/Application.hx",194,0x8bc55476)
				HX_STACK_ARG(a2,"a2")
				{
					HX_STACK_LINE(194)
		...
		HX_STACK_LINE(196)
		bool tmp69 = (window->renderer == null());		HX_STACK_VAR(tmp69,"tmp69");
		HX_STACK_LINE(196)
		if ((tmp69)){
			HX_STACK_LINE(198)
			::lime::graphics::Renderer tmp70 = ::lime::graphics::Renderer_obj::__new(window);		HX_STACK_VAR(tmp70,"tmp70");
			HX_STACK_LINE(198)
			::lime::graphics::Renderer renderer = tmp70;		HX_STACK_VAR(renderer,"renderer");
			HX_STACK_LINE(199)
			::lime::graphics::Renderer tmp71 = renderer;		HX_STACK_VAR(tmp71,"tmp71");
			HX_STACK_LINE(199)
			this->addRenderer(tmp71);
		}
		HX_STACK_LINE(203)
		...
		HX_STACK_LINE(204)
		this->windows->push(tmp70);
		HX_STACK_LINE(205)
		::haxe::ds::IntMap tmp71 = this->windowByID;		HX_STACK_VAR(tmp71,"tmp71");
		HX_STACK_LINE(205)
		int tmp72 = window->id;		HX_STACK_VAR(tmp72,"tmp72");
		HX_STACK_LINE(205)
		::lime::ui::Window tmp73 = window;		HX_STACK_VAR(tmp73,"tmp73");
		HX_STACK_LINE(205)
		tmp71->set(tmp72,tmp73);
		HX_STACK_LINE(207)
...
int Application_obj::exec( ){
	HX_STACK_FRAME("lime.app.Application","exec",0x508159f5,"lime.app.Application.exec","lime/app/Application.hx",218,0x8bc55476)
	HX_STACK_THIS(this)
	HX_STACK_LINE(220)
	::lime::app::Application_obj::current = hx::ObjectPtr<OBJ_>(this);
	HX_STACK_LINE(222)
...
{
		HX_STACK_FRAME("lime.app.Application","onGamepadAxisMove",0x507e62d0,"lime.app.Application.onGamepadAxisMove","lime/app/Application.hx",229,0x8bc55476)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("lime.app.Application","onGamepadButtonDown",0x00e65572,"lime.app.Application.onGamepadButtonDown","lime/app/Application.hx",240,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(gamepad,"gamepad")
...
{
		HX_STACK_FRAME("lime.app.Application","onGamepadButtonUp",0x1cbc5f6b,"lime.app.Application.onGamepadButtonUp","lime/app/Application.hx",251,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(gamepad,"gamepad")
		HX_STACK_ARG(button,"button")
		HX_STACK_LINE(251)
...
{
		HX_STACK_FRAME("lime.app.Application","onGamepadConnect",0xf3ecc32c,"lime.app.Application.onGamepadConnect","lime/app/Application.hx",262,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(gamepad,"gamepad")
		HX_STACK_LINE(262)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_FRAME("lime.app.Application","onGamepadDisconnect",0xbdc6525a,"lime.app.Application.onGamepadDisconnect","lime/app/Application.hx",273,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(gamepad,"gamepad")
		HX_STACK_LINE(273)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_FRAME("lime.app.Application","onJoystickAxisMove",0x646941d1,"lime.app.Application.onJoystickAxisMove","lime/app/Application.hx",284,0x8bc55476)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("lime.app.Application","onJoystickButtonDown",0x0c87b6b3,"lime.app.Application.onJoystickButtonDown","lime/app/Application.hx",295,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(joystick,"joystick")
		HX_STACK_ARG(button,"button")
		HX_STACK_LINE(295)
...
{
		HX_STACK_FRAME("lime.app.Application","onJoystickButtonUp",0x30a73e6c,"lime.app.Application.onJoystickButtonUp","lime/app/Application.hx",306,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(joystick,"joystick")
		HX_STACK_ARG(button,"button")
		HX_STACK_LINE(306)
...
{
		HX_STACK_FRAME("lime.app.Application","onJoystickConnect",0x26867f4b,"lime.app.Application.onJoystickConnect","lime/app/Application.hx",317,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(joystick,"joystick")
		HX_STACK_LINE(317)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_FRAME("lime.app.Application","onJoystickDisconnect",0xc967b39b,"lime.app.Application.onJoystickDisconnect","lime/app/Application.hx",328,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(joystick,"joystick")
		HX_STACK_LINE(328)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_FRAME("lime.app.Application","onJoystickHatMove",0xbc11db6d,"lime.app.Application.onJoystickHatMove","lime/app/Application.hx",339,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(joystick,"joystick")
...
{
		HX_STACK_FRAME("lime.app.Application","onJoystickTrackballMove",0xefab705c,"lime.app.Application.onJoystickTrackballMove","lime/app/Application.hx",350,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(joystick,"joystick")
...
{
		HX_STACK_FRAME("lime.app.Application","onKeyDown",0x622d115e,"lime.app.Application.onKeyDown","lime/app/Application.hx",361,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
...
{
		HX_STACK_FRAME("lime.app.Application","onKeyUp",0x55960857,"lime.app.Application.onKeyUp","lime/app/Application.hx",372,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
		HX_STACK_ARG(keyCode,"keyCode")
		HX_STACK_ARG(modifier,"modifier")
...
{
		HX_STACK_FRAME("lime.app.Application","onModuleExit",0x4a2a2a4d,"lime.app.Application.onModuleExit","lime/app/Application.hx",381,0x8bc55476)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("lime.app.Application","onMouseDown",0x372f8224,"lime.app.Application.onMouseDown","lime/app/Application.hx",396,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
...
{
		HX_STACK_FRAME("lime.app.Application","onMouseMove",0x3d226cd3,"lime.app.Application.onMouseMove","lime/app/Application.hx",407,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
...
{
		HX_STACK_FRAME("lime.app.Application","onMouseMoveRelative",0xf3ee70bf,"lime.app.Application.onMouseMoveRelative","lime/app/Application.hx",418,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
...
{
		HX_STACK_FRAME("lime.app.Application","onMouseUp",0x86589b9d,"lime.app.Application.onMouseUp","lime/app/Application.hx",429,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
...
{
		HX_STACK_FRAME("lime.app.Application","onMouseWheel",0xfe513499,"lime.app.Application.onMouseWheel","lime/app/Application.hx",440,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
...
{
		HX_STACK_FRAME("lime.app.Application","onPreloadComplete",0x8806a25f,"lime.app.Application.onPreloadComplete","lime/app/Application.hx",451,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_LINE(451)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(451)
...
{
		HX_STACK_FRAME("lime.app.Application","onPreloadProgress",0x8e699953,"lime.app.Application.onPreloadProgress","lime/app/Application.hx",462,0x8bc55476)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("lime.app.Application","onRenderContextLost",0xfdd705ba,"lime.app.Application.onRenderContextLost","lime/app/Application.hx",473,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(renderer,"renderer")
		HX_STACK_LINE(473)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_FRAME("lime.app.Application","onRenderContextRestored",0x4fd2fc2c,"lime.app.Application.onRenderContextRestored","lime/app/Application.hx",484,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(renderer,"renderer")
...
{
		HX_STACK_FRAME("lime.app.Application","onTextEdit",0xa9173afa,"lime.app.Application.onTextEdit","lime/app/Application.hx",495,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
...
{
		HX_STACK_FRAME("lime.app.Application","onTextInput",0x9f78251a,"lime.app.Application.onTextInput","lime/app/Application.hx",506,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
		HX_STACK_ARG(text,"text")
		HX_STACK_LINE(506)
...
{
		HX_STACK_FRAME("lime.app.Application","onTouchEnd",0x6316e2ff,"lime.app.Application.onTouchEnd","lime/app/Application.hx",517,0x8bc55476)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("lime.app.Application","onTouchMove",0x563a436d,"lime.app.Application.onTouchMove","lime/app/Application.hx",528,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(touch,"touch")
		HX_STACK_LINE(528)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_FRAME("lime.app.Application","onTouchStart",0x94666486,"lime.app.Application.onTouchStart","lime/app/Application.hx",539,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(touch,"touch")
		HX_STACK_LINE(539)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_FRAME("lime.app.Application","onWindowActivate",0xf2f355a6,"lime.app.Application.onWindowActivate","lime/app/Application.hx",550,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
		HX_STACK_LINE(550)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_FRAME("lime.app.Application","onWindowClose",0x133677e5,"lime.app.Application.onWindowClose","lime/app/Application.hx",559,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
		HX_STACK_LINE(561)
		{
...
{
		HX_STACK_FRAME("lime.app.Application","onWindowCreate",0x2a302e2f,"lime.app.Application.onWindowCreate","lime/app/Application.hx",574,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
		HX_STACK_LINE(574)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_FRAME("lime.app.Application","onWindowDeactivate",0x950138e7,"lime.app.Application.onWindowDeactivate","lime/app/Application.hx",585,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
		HX_STACK_LINE(585)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_FRAME("lime.app.Application","onWindowDropFile",0xf69db03e,"lime.app.Application.onWindowDropFile","lime/app/Application.hx",596,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
		...
		while((true)){
			...
			HX_STACK_LINE(598)
			module->onWindowDropFile(tmp3,tmp4);
		}
	}
return null();
}
...
{
		HX_STACK_FRAME("lime.app.Application","__onGamepadConnect",0x60fc374c,"lime.app.Application.__onGamepadConnect","lime/app/Application.hx",805,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(gamepad,"gamepad")
		HX_STACK_LINE(807)
...
{
		HX_STACK_FRAME("lime.app.Application","__onJoystickConnect",0x26fca72b,"lime.app.Application.__onJoystickConnect","lime/app/Application.hx",817,0x8bc55476)
		HX_STACK_THIS(this)
		HX_STACK_ARG(joystick,"joystick")
		HX_STACK_LINE(819)
		...
		HX_STACK_LINE(821)
		{
			...
			int __ArgCount() const { return 2; }
			Void run(int a2,Float a3){
				HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","lime/app/Application.hx",821,0x8bc55476)
				HX_STACK_ARG(a2,"a2")
				HX_STACK_ARG(a3,"a3")
				{
					HX_STACK_LINE(821)
		...
		HX_STACK_LINE(822)
		{
			...
			int __ArgCount() const { return 1; }
			Void run(int a2){
				HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","lime/app/Application.hx",822,0x8bc55476)
				HX_STACK_ARG(a2,"a2")
				{
					HX_STACK_LINE(822)
		...
		HX_STACK_LINE(823)
		{
			...
			int __ArgCount() const { return 1; }
			Void run(int a2){
				HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","lime/app/Application.hx",823,0x8bc55476)
				HX_STACK_ARG(a2,"a2")
				{
					HX_STACK_LINE(823)
		...
		HX_STACK_LINE(824)
		{
			...
			int __ArgCount() const { return 0; }
			Void run(){
				HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","lime/app/Application.hx",824,0x8bc55476)
				{
					HX_STACK_LINE(824)
		...
		HX_STACK_LINE(825)
		{
			...
			int __ArgCount() const { return 2; }
			Void run(int a2,int a3){
				HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","lime/app/Application.hx",825,0x8bc55476)
				HX_STACK_ARG(a2,"a2")
				HX_STACK_ARG(a3,"a3")
				{
					HX_STACK_LINE(825)
		...
		HX_STACK_LINE(826)
		{
			...
			int __ArgCount() const { return 2; }
			Void run(int a2,Float a3){
				HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","lime/app/Application.hx",826,0x8bc55476)
				HX_STACK_ARG(a2,"a2")
				HX_STACK_ARG(a3,"a3")
				{
					HX_STACK_LINE(826)
...
Float Application_obj::get_frameRate( ){
	HX_STACK_FRAME("lime.app.Application","get_frameRate",0x719f92a0,"lime.app.Application.get_frameRate","lime/app/Application.hx",838,0x8bc55476)
	HX_STACK_THIS(this)
	HX_STACK_LINE(840)
	::lime::_backend::native::NativeApplication tmp = this->backend;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(840)
...
Float Application_obj::set_frameRate( Float value){
	HX_STACK_FRAME("lime.app.Application","set_frameRate",0xb6a574ac,"lime.app.Application.set_frameRate","lime/app/Application.hx",845,0x8bc55476)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(847)
	::lime::_backend::native::NativeApplication tmp = this->backend;		HX_STACK_VAR(tmp,"tmp");
...
::lime::graphics::Renderer Application_obj::get_renderer( ){
	HX_STACK_FRAME("lime.app.Application","get_renderer",0xa67be3b0,"lime.app.Application.get_renderer","lime/app/Application.hx",852,0x8bc55476)
	HX_STACK_THIS(this)
	HX_STACK_LINE(854)
...
::lime::ui::Window Application_obj::get_window( ){
	HX_STACK_FRAME("lime.app.Application","get_window",0xc86a4d1d,"lime.app.Application.get_window","lime/app/Application.hx",859,0x8bc55476)
	HX_STACK_THIS(this)
	HX_STACK_LINE(861)
