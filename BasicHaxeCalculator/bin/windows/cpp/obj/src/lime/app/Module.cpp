...
Void Module_obj::onGamepadConnect( ::lime::ui::Gamepad gamepad){
{
		...
		HX_STACK_ARG(gamepad,"gamepad")
		HX_STACK_LINE(64)
		Dynamic tmp = hx::SourceInfo(HX_HCSTRING("Module.hx","\x72","\x21","\xcc","\xb7"),64,HX_HCSTRING("lime.app.Module","\xb2","\xd5","\xdb","\x18"),HX_HCSTRING("onGamepadConnect","\xc8","\x56","\xd7","\xec"));		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(64)
...
{
		HX_STACK_FRAME("lime.app.Module","onGamepadDisconnect",0x987e1782,"lime.app.Module.onGamepadDisconnect","lime/app/Module.hx",73,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(gamepad,"gamepad")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","onJoystickAxisMove",0xef2659a9,"lime.app.Module.onJoystickAxisMove","lime/app/Module.hx",82,0x653a538a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("lime.app.Module","onJoystickButtonDown",0x929c748b,"lime.app.Module.onJoystickButtonDown","lime/app/Module.hx",90,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(joystick,"joystick")
		HX_STACK_ARG(button,"button")
	}
...
{
		HX_STACK_FRAME("lime.app.Module","onJoystickButtonUp",0xbb645644,"lime.app.Module.onJoystickButtonUp","lime/app/Module.hx",98,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(joystick,"joystick")
		HX_STACK_ARG(button,"button")
	}
...
{
		HX_STACK_FRAME("lime.app.Module","onJoystickConnect",0x195f2a73,"lime.app.Module.onJoystickConnect","lime/app/Module.hx",105,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(joystick,"joystick")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","onJoystickDisconnect",0x4f7c7173,"lime.app.Module.onJoystickDisconnect","lime/app/Module.hx",112,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(joystick,"joystick")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","onJoystickHatMove",0xaeea8695,"lime.app.Module.onJoystickHatMove","lime/app/Module.hx",121,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(joystick,"joystick")
...
{
		HX_STACK_FRAME("lime.app.Module","onJoystickTrackballMove",0xea30e984,"lime.app.Module.onJoystickTrackballMove","lime/app/Module.hx",130,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(joystick,"joystick")
...
{
		HX_STACK_FRAME("lime.app.Module","onKeyDown",0x83d25486,"lime.app.Module.onKeyDown","lime/app/Module.hx",139,0x653a538a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("lime.app.Module","onKeyUp",0x3060b17f,"lime.app.Module.onKeyUp","lime/app/Module.hx",148,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
		HX_STACK_ARG(keyCode,"keyCode")
		HX_STACK_ARG(modifier,"modifier")
...
{
		HX_STACK_FRAME("lime.app.Module","onModuleExit",0x61615025,"lime.app.Module.onModuleExit","lime/app/Module.hx",154,0x653a538a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("lime.app.Module","onMouseDown",0xff09df4c,"lime.app.Module.onMouseDown","lime/app/Module.hx",164,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
...
{
		HX_STACK_FRAME("lime.app.Module","onMouseMove",0x04fcc9fb,"lime.app.Module.onMouseMove","lime/app/Module.hx",174,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
...
{
		HX_STACK_FRAME("lime.app.Module","onMouseMoveRelative",0xcea635e7,"lime.app.Module.onMouseMoveRelative","lime/app/Module.hx",184,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
...
{
		HX_STACK_FRAME("lime.app.Module","onMouseUp",0xa7fddec5,"lime.app.Module.onMouseUp","lime/app/Module.hx",194,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
...
{
		HX_STACK_FRAME("lime.app.Module","onMouseWheel",0x15885a71,"lime.app.Module.onMouseWheel","lime/app/Module.hx",203,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
...
{
		HX_STACK_FRAME("lime.app.Module","onPreloadComplete",0x7adf4d87,"lime.app.Module.onPreloadComplete","lime/app/Module.hx",209,0x653a538a)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("lime.app.Module","onPreloadProgress",0x8142447b,"lime.app.Module.onPreloadProgress","lime/app/Module.hx",217,0x653a538a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("lime.app.Module","onRenderContextLost",0xd88ecae2,"lime.app.Module.onRenderContextLost","lime/app/Module.hx",224,0x653a538a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("lime.app.Module","onRenderContextRestored",0x4a587554,"lime.app.Module.onRenderContextRestored","lime/app/Module.hx",232,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(renderer,"renderer")
...
{
		HX_STACK_FRAME("lime.app.Module","onTextEdit",0xf80cbad2,"lime.app.Module.onTextEdit","lime/app/Module.hx",242,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
...
{
		HX_STACK_FRAME("lime.app.Module","onTextInput",0x67528242,"lime.app.Module.onTextInput","lime/app/Module.hx",250,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
		HX_STACK_ARG(text,"text")
	}
...
{
		HX_STACK_FRAME("lime.app.Module","onTouchEnd",0xb20c62d7,"lime.app.Module.onTouchEnd","lime/app/Module.hx",257,0x653a538a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("lime.app.Module","onTouchMove",0x1e14a095,"lime.app.Module.onTouchMove","lime/app/Module.hx",264,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(touch,"touch")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","onTouchStart",0xab9d8a5e,"lime.app.Module.onTouchStart","lime/app/Module.hx",271,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(touch,"touch")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowActivate",0xa3ae477e,"lime.app.Module.onWindowActivate","lime/app/Module.hx",278,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowClose",0x4c406f0d,"lime.app.Module.onWindowClose","lime/app/Module.hx",285,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowCreate",0xd9de7a07,"lime.app.Module.onWindowCreate","lime/app/Module.hx",292,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowDeactivate",0x1fbe50bf,"lime.app.Module.onWindowDeactivate","lime/app/Module.hx",299,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowDropFile",0xa758a216,"lime.app.Module.onWindowDropFile","lime/app/Module.hx",306,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowEnter",0x7463c46d,"lime.app.Module.onWindowEnter","lime/app/Module.hx",313,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowFocusIn",0xf8e4dc72,"lime.app.Module.onWindowFocusIn","lime/app/Module.hx",320,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowFocusOut",0xcf609b61,"lime.app.Module.onWindowFocusOut","lime/app/Module.hx",327,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowFullscreen",0xdd712ec6,"lime.app.Module.onWindowFullscreen","lime/app/Module.hx",334,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowLeave",0x76308c4c,"lime.app.Module.onWindowLeave","lime/app/Module.hx",341,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowMove",0x01388d5c,"lime.app.Module.onWindowMove","lime/app/Module.hx",350,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowMinimize",0xdf7b6ae9,"lime.app.Module.onWindowMinimize","lime/app/Module.hx",357,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowResize",0x664a6cff,"lime.app.Module.onWindowResize","lime/app/Module.hx",366,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowRestore",0x2211fde3,"lime.app.Module.onWindowRestore","lime/app/Module.hx",373,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","render",0xc490e692,"lime.app.Module.render","lime/app/Module.hx",380,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(renderer,"renderer")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","update",0x466d0145,"lime.app.Module.update","lime/app/Module.hx",387,0x653a538a)
		HX_STACK_THIS(this)
