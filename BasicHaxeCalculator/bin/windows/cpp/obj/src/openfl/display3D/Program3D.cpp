...
Void Program3D_obj::__construct(::openfl::display3D::Context3D context,::lime::graphics::opengl::GLProgram program)
{
...
hx::ObjectPtr< Program3D_obj > Program3D_obj::__new(::openfl::display3D::Context3D context,::lime::graphics::opengl::GLProgram program)
...
Void Program3D_obj::upload( ::lime::graphics::opengl::GLShader vertexShader,::lime::graphics::opengl::GLShader fragmentShader){
{
		...
		HX_STACK_LINE(37)
		{
			...
			::lime::graphics::opengl::GLProgram tmp = this->glProgram;		HX_STACK_VAR(tmp,"tmp");
			HX_STACK_LINE(37)
			int program = tmp->id;		HX_STACK_VAR(program,"program");
			HX_STACK_LINE(37)
		...
		{
			HX_STACK_LINE(39)
			::lime::graphics::opengl::GLProgram tmp1 = this->glProgram;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(39)
			int program = tmp1->id;		HX_STACK_VAR(program,"program");
			HX_STACK_LINE(39)
			tmp = ::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_program_parameter.call(program,(int)35714);
		}
		HX_STACK_LINE(39)
		...
		if ((tmp1)){
			...
			{
				HX_STACK_LINE(41)
				::lime::graphics::opengl::GLProgram tmp3 = this->glProgram;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(41)
				int program = tmp3->id;		HX_STACK_VAR(program,"program");
				HX_STACK_LINE(41)
				tmp2 = ::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_program_info_log.call(program);
			}
			HX_STACK_LINE(41)
			::String result = tmp2;		HX_STACK_VAR(result,"result");
			HX_STACK_LINE(42)
			bool tmp3 = (result != HX_HCSTRING("","\x00","\x00","\x00","\x00"));		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(42)
			if ((tmp3)){
				HX_STACK_LINE(42)
