...
Void Context3D_obj::setBackBufferViewPort( Dynamic x,Dynamic y,Dynamic width,Dynamic height){
{
		...
		if ((tmp)){
			HX_STACK_LINE(149)
			::openfl::geom::Rectangle tmp1 = this->scrollRect;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(149)
		...
		if ((tmp1)){
			HX_STACK_LINE(150)
			::openfl::geom::Rectangle tmp2 = this->scrollRect;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(150)
		...
		if ((tmp2)){
			HX_STACK_LINE(151)
			::openfl::geom::Rectangle tmp3 = this->scrollRect;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(151)
		...
		tmp4->x = x;
		HX_STACK_LINE(155)
		::openfl::geom::Rectangle tmp5 = this->scrollRect;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(155)
		tmp5->y = y;
		HX_STACK_LINE(156)
		::openfl::geom::Rectangle tmp6 = this->scrollRect;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(156)
		tmp6->width = width;
		HX_STACK_LINE(157)
...
Void Context3D_obj::updateBackBufferViewPort( ){
{
		...
		if ((tmp1)){
			...
			HX_STACK_LINE(169)
			::openfl::geom::Rectangle tmp8 = this->scrollRect;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(169)
			...
			HX_STACK_LINE(169)
			::openfl::geom::Rectangle tmp11 = this->scrollRect;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(169)
...
Void Context3D_obj::updateDepthAndStencilState( ){
{
		...
		HX_STACK_LINE(181)
		bool tmp2 = depthAndStencil;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(181)
		if ((tmp2)){
			HX_STACK_LINE(184)
			::lime::app::Application tmp3 = ::lime::app::Application_obj::current;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(184)
			::lime::ui::Window tmp4 = tmp3->windows->__get((int)0).StaticCast< ::lime::ui::Window >();		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(184)
			Dynamic tmp5 = tmp4->config->__Field(HX_HCSTRING("depthBuffer","\x63","\x46","\x9e","\x52"), hx::paccDynamic );		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(184)
			if ((tmp5)){
				HX_STACK_LINE(185)
			...
			HX_STACK_LINE(186)
			Dynamic tmp8 = tmp7->config->__Field(HX_HCSTRING("stencilBuffer","\x1c","\x94","\x39","\x31"), hx::paccDynamic );		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(186)
			if ((tmp8)){
				HX_STACK_LINE(187)
...
Void Context3D_obj::updateScissorRectangle( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(857)
		::openfl::geom::Rectangle tmp = this->scissorRectangle;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(857)
		bool tmp1 = (tmp == null());		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(857)
		if ((tmp1)){
		...
		{
			HX_STACK_LINE(862)
			::openfl::geom::Rectangle tmp4 = this->scissorRectangle;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(862)
			...
			HX_STACK_LINE(863)
			::openfl::geom::Rectangle tmp8 = this->scissorRectangle;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(863)
			...
			HX_STACK_LINE(863)
			::openfl::geom::Rectangle tmp12 = this->scissorRectangle;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(863)
			...
			HX_STACK_LINE(864)
			::openfl::geom::Rectangle tmp17 = this->scissorRectangle;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(864)
			...
			HX_STACK_LINE(865)
			::openfl::geom::Rectangle tmp20 = this->scissorRectangle;		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(865)
			...
			switch( (int)(filter->__Index())){
					...
					if ((tmp4)){
						struct _Function_4_1{
							inline static bool Block( ){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/display3D/Context3D.hx",967,0xc899cbb9)
								{
									HX_STACK_LINE(967)
				...
				case (int)1: {
					...
					if ((tmp4)){
						struct _Function_4_1{
							inline static bool Block( ){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/display3D/Context3D.hx",972,0xc899cbb9)
								{
									HX_STACK_LINE(972)
									int a = ::openfl::display3D::Context3D_obj::maxSupportedAnisotropy;		HX_STACK_VAR(a,"a");
									struct _Function_5_1{
				...
				case (int)2: {
					...
					if ((tmp4)){
						struct _Function_4_1{
							inline static bool Block( ){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/display3D/Context3D.hx",977,0xc899cbb9)
								{
									HX_STACK_LINE(977)
									int a = ::openfl::display3D::Context3D_obj::maxSupportedAnisotropy;		HX_STACK_VAR(a,"a");
									struct _Function_5_1{
				...
				case (int)3: {
					...
					if ((tmp4)){
						struct _Function_4_1{
							inline static bool Block( ){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/display3D/Context3D.hx",982,0xc899cbb9)
								{
									HX_STACK_LINE(982)
									int a = ::openfl::display3D::Context3D_obj::maxSupportedAnisotropy;		HX_STACK_VAR(a,"a");
									struct _Function_5_1{
				...
				switch( (int)(filter->__Index())){
					...
					case (int)0: {
						...
						if ((tmp6)){
							struct _Function_5_1{
								inline static bool Block( ){
									HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/display3D/Context3D.hx",1031,0xc899cbb9)
									{
										HX_STACK_LINE(1031)
										int a = ::openfl::display3D::Context3D_obj::maxSupportedAnisotropy;		HX_STACK_VAR(a,"a");
					...
					case (int)1: {
						...
						if ((tmp6)){
							struct _Function_5_1{
								inline static bool Block( ){
									HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/display3D/Context3D.hx",1036,0xc899cbb9)
									{
										HX_STACK_LINE(1036)
										int a = ::openfl::display3D::Context3D_obj::maxSupportedAnisotropy;		HX_STACK_VAR(a,"a");
										struct _Function_6_1{
					...
					case (int)2: {
						...
						if ((tmp6)){
							struct _Function_5_1{
								inline static bool Block( ){
									HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/display3D/Context3D.hx",1041,0xc899cbb9)
									{
										HX_STACK_LINE(1041)
										int a = ::openfl::display3D::Context3D_obj::maxSupportedAnisotropy;		HX_STACK_VAR(a,"a");
										struct _Function_6_1{
					...
					case (int)3: {
						...
						if ((tmp6)){
							struct _Function_5_1{
								inline static bool Block( ){
									HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/display3D/Context3D.hx",1046,0xc899cbb9)
									{
										HX_STACK_LINE(1046)
										int a = ::openfl::display3D::Context3D_obj::maxSupportedAnisotropy;		HX_STACK_VAR(a,"a");
										struct _Function_6_1{
					...
					switch( (int)(filter->__Index())){
						...
						case (int)0: {
							...
							if ((tmp8)){
								struct _Function_6_1{
									inline static bool Block( ){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/display3D/Context3D.hx",1085,0xc899cbb9)
										{
											HX_STACK_LINE(1085)
											int a = ::openfl::display3D::Context3D_obj::maxSupportedAnisotropy;		HX_STACK_VAR(a,"a");
						...
						case (int)1: {
							...
							if ((tmp8)){
								struct _Function_6_1{
									inline static bool Block( ){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/display3D/Context3D.hx",1090,0xc899cbb9)
										{
											HX_STACK_LINE(1090)
											int a = ::openfl::display3D::Context3D_obj::maxSupportedAnisotropy;		HX_STACK_VAR(a,"a");
											struct _Function_7_1{
						...
						case (int)2: {
							...
							if ((tmp8)){
								struct _Function_6_1{
									inline static bool Block( ){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/display3D/Context3D.hx",1095,0xc899cbb9)
										{
											HX_STACK_LINE(1095)
											int a = ::openfl::display3D::Context3D_obj::maxSupportedAnisotropy;		HX_STACK_VAR(a,"a");
											struct _Function_7_1{
						...
						case (int)3: {
							...
							if ((tmp8)){
								struct _Function_6_1{
									inline static bool Block( ){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/display3D/Context3D.hx",1100,0xc899cbb9)
										{
											HX_STACK_LINE(1100)
											int a = ::openfl::display3D::Context3D_obj::maxSupportedAnisotropy;		HX_STACK_VAR(a,"a");
											struct _Function_7_1{
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::geom::Rectangle*/ ,(int)offsetof(Context3D_obj,scissorRectangle),HX_HCSTRING("scissorRectangle","\x73","\xa8","\x68","\x0c")},
