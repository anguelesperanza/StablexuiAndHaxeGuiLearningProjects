...
::lime::app::Future Assets_obj::loadBytes( ::String id,Dynamic handler){
	...
	if ((tmp3)){
		...
		int __ArgCount() const { return 1; }
		Void run(Dynamic _){
			HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","openfl/Assets.hx",563,0x989d477c)
			HX_STACK_ARG(_,"_")
			{
				HX_STACK_LINE(563)
				handler(null()).Cast< Void >();
		...
		Void run(::lime::utils::Bytes bytes){
			HX_STACK_FRAME("*","_Function_2_2",0x5201af79,"*._Function_2_2","openfl/Assets.hx",565,0x989d477c)
		...
		Void run(Float progress){
			HX_STACK_FRAME("*","_Function_2_3",0x5201af7a,"*._Function_2_3","openfl/Assets.hx",566,0x989d477c)
		...
		Void run(Dynamic msg){
			HX_STACK_FRAME("*","_Function_2_4",0x5201af7b,"*._Function_2_4","openfl/Assets.hx",567,0x989d477c)
	...
	HX_STACK_ARG(handler,"handler")
{
		...
		if ((tmp2)){
			...
			int __ArgCount() const { return 1; }
			Void run(Dynamic _){
				HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","openfl/Assets.hx",593,0x989d477c)
				HX_STACK_ARG(_,"_")
				{
					HX_STACK_LINE(593)
					handler(null()).Cast< Void >();
		...
		Void run(::lime::text::Font limeFont){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","openfl/Assets.hx",606,0x989d477c)
...
::lime::app::Future Assets_obj::loadLibrary( ::String name,Dynamic handler){
	...
	if ((tmp2)){
		...
		int __ArgCount() const { return 1; }
		Void run(Dynamic _){
			HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","openfl/Assets.hx",644,0x989d477c)
			HX_STACK_ARG(_,"_")
			{
				HX_STACK_LINE(644)
				handler(null()).Cast< Void >();
	...
	HX_STACK_ARG(handler,"handler")
{
		...
		Void run(::lime::audio::AudioBuffer buffer){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","openfl/Assets.hx",669,0x989d477c)
...
::lime::app::Future Assets_obj::loadMovieClip( ::String id,Dynamic handler){
	...
	if ((tmp1)){
		...
		int __ArgCount() const { return 1; }
		Void run(Dynamic _){
			HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","openfl/Assets.hx",712,0x989d477c)
			HX_STACK_ARG(_,"_")
			{
				HX_STACK_LINE(712)
				handler(null()).Cast< Void >();
	...
	HX_STACK_ARG(handler,"handler")
{
		...
		int __ArgCount() const { return 1; }
		Void run(::lime::audio::AudioBuffer buffer){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","openfl/Assets.hx",763,0x989d477c)
			HX_STACK_ARG(buffer,"buffer")
			{
				HX_STACK_LINE(765)
				bool tmp5 = (buffer != null());		HX_STACK_VAR(tmp5,"tmp5");
...
::lime::app::Future Assets_obj::loadText( ::String id,Dynamic handler){
	...
	if ((tmp2)){
		...
		int __ArgCount() const { return 1; }
		Void run(Dynamic _){
			HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","openfl/Assets.hx",806,0x989d477c)
			HX_STACK_ARG(_,"_")
			{
				HX_STACK_LINE(806)
				handler(null()).Cast< Void >();
...
{
		HX_STACK_FRAME("openfl.Assets","registerLibrary",0x9230822b,"openfl.Assets.registerLibrary","openfl/Assets.hx",820,0x989d477c)
		HX_STACK_ARG(name,"name")
...
bool capture = __o_capture.Default(false);
	HX_STACK_FRAME("openfl.Assets","removeEventListener",0x6a2b249d,"openfl.Assets.removeEventListener","openfl/Assets.hx",827,0x989d477c)
	HX_STACK_ARG(type,"type")
	HX_STACK_ARG(listener,"listener")
...
::hx::Class Assets_obj::resolveClass( ::String name){
	HX_STACK_FRAME("openfl.Assets","resolveClass",0x76ca4479,"openfl.Assets.resolveClass","openfl/Assets.hx",834,0x989d477c)
	HX_STACK_ARG(name,"name")
	HX_STACK_LINE(836)
	::String tmp = name;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(836)
...
{
		HX_STACK_FRAME("openfl.Assets","unloadLibrary",0x6a51c84f,"openfl.Assets.unloadLibrary","openfl/Assets.hx",860,0x989d477c)
		HX_STACK_ARG(name,"name")
		HX_STACK_LINE(862)
		::String tmp = name;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(862)
...
{
		HX_STACK_FRAME("openfl.Assets","LimeAssets_onChange",0xaa15d389,"openfl.Assets.LimeAssets_onChange","openfl/Assets.hx",874,0x989d477c)
		HX_STACK_LINE(876)
