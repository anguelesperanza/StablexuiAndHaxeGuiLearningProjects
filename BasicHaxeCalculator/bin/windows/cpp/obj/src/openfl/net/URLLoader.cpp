...
Void URLLoader_obj::requestUrl( ::String url,Dynamic method,Dynamic data,Array< ::Dynamic > requestHeaders){
{
		...
		switch( (int)(tmp6)){
			...
			default: {
				...
				Float tmp7 = this->__curl;		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(398)
				Dynamic tmp8 = method;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(398)
				...
				HX_STACK_LINE(399)
				::openfl::utils::ByteArrayData tmp11 = uri;		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(399)
				...
				HX_STACK_LINE(399)
				{
					...
					HX_STACK_LINE(399)
					::openfl::utils::ByteArrayData a2 = tmp11;		HX_STACK_VAR(a2,"a2");

					HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_Function_3_1,Dynamic,f,::openfl::utils::ByteArrayData,a2)
					int __ArgCount() const { return 1; }
					::lime::utils::Bytes run(int a1){
						HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","openfl/net/URLLoader.hx",399,0x11daec0d)
						HX_STACK_ARG(a1,"a1")
						{
							HX_STACK_LINE(399)
							int tmp13 = a1;		HX_STACK_VAR(tmp13,"tmp13");
							HX_STACK_LINE(399)
							::openfl::utils::ByteArrayData tmp14 = a2;		HX_STACK_VAR(tmp14,"tmp14");
							HX_STACK_LINE(399)
							::lime::utils::Bytes tmp15 = f(tmp13,tmp14).Cast< ::lime::utils::Bytes >();		HX_STACK_VAR(tmp15,"tmp15");
							HX_STACK_LINE(399)
							return tmp15;
						}
						return null();
				...
				HX_STACK_LINE(400)
				::openfl::utils::ByteArrayData tmp14 = uri;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(400)
				int tmp15 = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(tmp14);		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(400)
				::lime::net::curl::CURLEasy_obj::setopt(tmp13,(int)14,tmp15);
			}
		}
		HX_STACK_LINE(404)
		...
		int __ArgCount() const { return 1; }
		Void run(Dynamic _){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","openfl/net/URLLoader.hx",428,0x11daec0d)
			HX_STACK_ARG(_,"_")
			{
				HX_STACK_LINE(430)
		...
		int __ArgCount() const { return 1; }
		Void run(int result){
			HX_STACK_FRAME("*","_Function_1_2",0x5200ed38,"*._Function_1_2","openfl/net/URLLoader.hx",434,0x11daec0d)
...
int URLLoader_obj::headerFunction( ::haxe::io::Bytes output,int size,int nmemb){
	HX_STACK_FRAME("openfl.net.URLLoader","headerFunction",0x642c53c0,"openfl.net.URLLoader.headerFunction","openfl/net/URLLoader.hx",479,0x11daec0d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(output,"output")
	HX_STACK_ARG(size,"size")
	HX_STACK_ARG(nmemb,"nmemb")
...
::lime::utils::Bytes URLLoader_obj::readFunction( int max,::openfl::utils::ByteArrayData input){
	HX_STACK_FRAME("openfl.net.URLLoader","readFunction",0x284701c9,"openfl.net.URLLoader.readFunction","openfl/net/URLLoader.hx",509,0x11daec0d)
	HX_STACK_THIS(this)
...
Dynamic URLLoader_obj::set_dataFormat( Dynamic inputVal){
	HX_STACK_FRAME("openfl.net.URLLoader","set_dataFormat",0x4cc5d3b9,"openfl.net.URLLoader.set_dataFormat","openfl/net/URLLoader.hx",602,0x11daec0d)
	HX_STACK_THIS(this)
