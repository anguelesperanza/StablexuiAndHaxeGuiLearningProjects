...
::openfl::geom::Matrix Transform_obj::get_matrix( ){
	HX_STACK_FRAME("openfl.geom.Transform","get_matrix",0x80c3ba80,"openfl.geom.Transform.get_matrix","openfl/geom/Transform.hx",73,0xf4f475e6)
	HX_STACK_THIS(this)
	HX_STACK_LINE(75)
...
::openfl::geom::Matrix Transform_obj::get_concatenatedMatrix( ){
	HX_STACK_FRAME("openfl.geom.Transform","get_concatenatedMatrix",0x352d276f,"openfl.geom.Transform.get_concatenatedMatrix","openfl/geom/Transform.hx",86,0xf4f475e6)
	HX_STACK_THIS(this)
	HX_STACK_LINE(88)
	bool tmp = this->__hasMatrix;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(88)
