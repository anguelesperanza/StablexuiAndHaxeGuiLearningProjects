...
{
HX_STACK_FRAME("openfl.events._EventDispatcher.Listener","new",0x63be323b,"openfl.events._EventDispatcher.Listener.new","openfl/events/EventDispatcher.hx",307,0xe2270714)
HX_STACK_THIS(this)
...
bool Listener_obj::match( Dynamic callback,bool useCapture){
	HX_STACK_FRAME("openfl.events._EventDispatcher.Listener","match",0xdf4e17e0,"openfl.events._EventDispatcher.Listener.match","openfl/events/EventDispatcher.hx",316,0xe2270714)
	HX_STACK_THIS(this)
	HX_STACK_ARG(callback,"callback")
	HX_STACK_ARG(useCapture,"useCapture")
	HX_STACK_LINE(318)
