...
{
HX_STACK_FRAME("openfl.events.Event","new",0x2731c6f5,"openfl.events.Event.new","openfl/events/Event.hx",50,0x7220a03b)
HX_STACK_THIS(this)
...
::openfl::events::Event Event_obj::clone( ){
	HX_STACK_FRAME("openfl.events.Event","clone",0x5b9b9932,"openfl.events.Event.clone","openfl/events/Event.hx",60,0x7220a03b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(62)
...
::String Event_obj::formatToString( ::String className,::String p1,::String p2,::String p3,::String p4,::String p5){
	HX_STACK_FRAME("openfl.events.Event","formatToString",0xed38428e,"openfl.events.Event.formatToString","openfl/events/Event.hx",71,0x7220a03b)
	HX_STACK_THIS(this)
...
bool Event_obj::isDefaultPrevented( ){
	HX_STACK_FRAME("openfl.events.Event","isDefaultPrevented",0x5475e94b,"openfl.events.Event.isDefaultPrevented","openfl/events/Event.hx",85,0x7220a03b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(87)
...
{
		HX_STACK_FRAME("openfl.events.Event","preventDefault",0xdba9c454,"openfl.events.Event.preventDefault","openfl/events/Event.hx",92,0x7220a03b)
		HX_STACK_THIS(this)
		HX_STACK_LINE(94)
...
{
		HX_STACK_FRAME("openfl.events.Event","stopImmediatePropagation",0xa67252c8,"openfl.events.Event.stopImmediatePropagation","openfl/events/Event.hx",103,0x7220a03b)
		HX_STACK_THIS(this)
		HX_STACK_LINE(105)
...
{
		HX_STACK_FRAME("openfl.events.Event","stopPropagation",0xb07183ff,"openfl.events.Event.stopPropagation","openfl/events/Event.hx",113,0x7220a03b)
		HX_STACK_THIS(this)
		HX_STACK_LINE(113)
		this->__isCanceled = true;
	}
...
::String Event_obj::toString( ){
	HX_STACK_FRAME("openfl.events.Event","toString",0x6e61ddf7,"openfl.events.Event.toString","openfl/events/Event.hx",118,0x7220a03b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(120)
...
::String Event_obj::__formatToString( ::String className,Array< ::String > parameters){
	HX_STACK_FRAME("openfl.events.Event","__formatToString",0x9d75066e,"openfl.events.Event.__formatToString","openfl/events/Event.hx",125,0x7220a03b)
	HX_STACK_THIS(this)
	HX_STACK_ARG(className,"className")
