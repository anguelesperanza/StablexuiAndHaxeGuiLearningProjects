...
Void GLRenderer_obj::renderDisplayObject( ::openfl::display::DisplayObject displayObject,::openfl::geom::Point projection,::lime::graphics::opengl::GLFramebuffer buffer){
{
		...
		HX_STACK_LINE(333)
		tmp->blendModeManager->setBlendMode(((Dynamic)((int)10)),null());
		HX_STACK_LINE(335)
	...
	HX_STACK_ARG(smooth,"smooth")
{
		...
		HX_STACK_LINE(326)
		Dynamic tmp23 = shape->__blendMode;		HX_STACK_VAR(tmp23,"tmp23");
		HX_STACK_LINE(326)
		renderSession->spriteBatch->renderBitmapData(tmp18,tmp19,tmp20,tmp21,tmp22,tmp23,null(),((Dynamic)((int)0)),null());
	}
return null();
}
