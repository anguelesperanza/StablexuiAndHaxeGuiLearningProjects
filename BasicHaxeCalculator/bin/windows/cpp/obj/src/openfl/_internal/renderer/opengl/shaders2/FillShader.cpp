...
HX_STACK_ARG(gl,"gl")
{
	...
	HX_STACK_LINE(17)
	::String tmp7 = (HX_HCSTRING("uniform vec4 ","\xd4","\xf8","\xa8","\x3d") + HX_HCSTRING("openfl_uColor","\xbd","\x58","\x30","\xbb"));		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(17)
	::String tmp8 = (tmp7 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(18)
	::String tmp9 = (HX_HCSTRING("uniform float ","\x70","\x08","\x5a","\x60") + HX_HCSTRING("openfl_uAlpha","\xb8","\x8e","\x6a","\x92"));		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(18)
	::String tmp10 = (tmp9 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp10,"tmp10");
	HX_STACK_LINE(19)
	::String tmp11 = (HX_HCSTRING("uniform vec4 ","\xd4","\xf8","\xa8","\x3d") + HX_HCSTRING("openfl_uColorMultiplier","\x9e","\x72","\x0d","\x28"));		HX_STACK_VAR(tmp11,"tmp11");
	HX_STACK_LINE(19)
	::String tmp12 = (tmp11 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp12,"tmp12");
	HX_STACK_LINE(20)
	::String tmp13 = (HX_HCSTRING("uniform vec4 ","\xd4","\xf8","\xa8","\x3d") + HX_HCSTRING("openfl_uColorOffset","\x30","\x10","\x2f","\xe8"));		HX_STACK_VAR(tmp13,"tmp13");
	HX_STACK_LINE(20)
	...
	HX_STACK_LINE(35)
	::String tmp21 = (HX_HCSTRING("   vColor = colorTransform(","\xe9","\x4a","\x56","\xf6") + HX_HCSTRING("openfl_uColor","\xbd","\x58","\x30","\xbb"));		HX_STACK_VAR(tmp21,"tmp21");
	HX_STACK_LINE(35)
