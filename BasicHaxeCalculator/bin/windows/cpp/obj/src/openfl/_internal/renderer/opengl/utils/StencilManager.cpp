...
Void StencilManager_obj::prepareGraphics( ::openfl::_internal::renderer::opengl::utils::GLBucketData fill,::openfl::_internal::renderer::RenderSession renderSession,::lime::utils::ArrayBufferView translationMatrix){
{
		...
		{
			HX_STACK_LINE(45)
			int tmp2 = shader->getUniformLocation(HX_HCSTRING("openfl_uTranslationMatrix","\x6c","\x2c","\xb6","\x64"));		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(45)
		...
		{
			HX_STACK_LINE(46)
			int tmp2 = shader->getUniformLocation(HX_HCSTRING("openfl_uProjectionMatrix","\x16","\x8b","\xff","\x93"));		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(46)
			int location = tmp2;		HX_STACK_VAR(location,"location");
			HX_STACK_LINE(46)
		...
		HX_STACK_LINE(67)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(69)
				{
					...
					{
						HX_STACK_LINE(69)
						int tmp8 = shader->getUniformLocation(HX_HCSTRING("openfl_uTranslationMatrix","\x6c","\x2c","\xb6","\x64"));		HX_STACK_VAR(tmp8,"tmp8");
						HX_STACK_LINE(69)
					...
					{
						HX_STACK_LINE(69)
						int tmp8 = shader->getUniformLocation(HX_HCSTRING("openfl_uProjectionMatrix","\x16","\x8b","\xff","\x93"));		HX_STACK_VAR(tmp8,"tmp8");
						HX_STACK_LINE(69)
						int location = tmp8;		HX_STACK_VAR(location,"location");
						HX_STACK_LINE(69)
