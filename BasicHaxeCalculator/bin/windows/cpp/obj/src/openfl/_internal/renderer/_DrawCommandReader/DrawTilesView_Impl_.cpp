...
::openfl::_internal::renderer::DrawCommandReader DrawTilesView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_","_new",0x5728ce51,"openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",365,0xbbdbd1ae)
	HX_STACK_ARG(d,"d")
	HX_STACK_LINE(365)
...
::openfl::display::Tilesheet DrawTilesView_Impl__obj::get_sheet( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_","get_sheet",0x872b2006,"openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_.get_sheet","openfl/_internal/renderer/DrawCommandReader.hx",366,0xbbdbd1ae)
...
Array< Float > DrawTilesView_Impl__obj::get_tileData( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_","get_tileData",0x40575971,"openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_.get_tileData","openfl/_internal/renderer/DrawCommandReader.hx",367,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(367)
...
bool DrawTilesView_Impl__obj::get_smooth( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_","get_smooth",0xa63584e7,"openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_.get_smooth","openfl/_internal/renderer/DrawCommandReader.hx",368,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(368)
...
int DrawTilesView_Impl__obj::get_flags( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_","get_flags",0x0d9768ae,"openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_.get_flags","openfl/_internal/renderer/DrawCommandReader.hx",369,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(369)
...
::openfl::display::Shader DrawTilesView_Impl__obj::get_shader( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_","get_shader",0xbbeb3bde,"openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_.get_shader","openfl/_internal/renderer/DrawCommandReader.hx",370,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(370)
...
int DrawTilesView_Impl__obj::get_count( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_","get_count",0x556e8236,"openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_.get_count","openfl/_internal/renderer/DrawCommandReader.hx",371,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(371)
