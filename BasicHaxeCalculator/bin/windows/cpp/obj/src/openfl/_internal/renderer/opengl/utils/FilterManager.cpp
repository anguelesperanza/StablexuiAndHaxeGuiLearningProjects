...
Void FilterManager_obj::destroy( ){
{
		...
		HX_STACK_LINE(124)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(124)
				::openfl::_internal::renderer::opengl::utils::RenderTexture tmp3 = _g1->__get(_g).StaticCast< ::openfl::_internal::renderer::opengl::utils::RenderTexture >();		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(124)
				::openfl::_internal::renderer::opengl::utils::RenderTexture texture = tmp3;		HX_STACK_VAR(texture,"texture");
				HX_STACK_LINE(124)
				++(_g);
				HX_STACK_LINE(126)
				texture->destroy();
