...
HX_STACK_ARG(gl,"gl")
{
	...
	HX_STACK_LINE(15)
	::String tmp3 = (HX_HCSTRING("attribute vec2 ","\xfe","\x43","\xff","\xbe") + HX_HCSTRING("openfl_aTexCoord0","\x10","\x9c","\x05","\xd4"));		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(15)
	::String tmp4 = (tmp3 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(16)
	::String tmp5 = (HX_HCSTRING("attribute vec4 ","\xbc","\x45","\xff","\xbe") + HX_HCSTRING("openfl_aColor","\x51","\x21","\x0d","\xbc"));		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(16)
	::String tmp6 = (tmp5 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(17)
	::String tmp7 = (HX_HCSTRING("uniform mat3 ","\x41","\xcb","\x75","\x0c") + HX_HCSTRING("openfl_uProjectionMatrix","\x16","\x8b","\xff","\x93"));		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(17)
	...
	HX_STACK_LINE(23)
	::String tmp11 = (tmp10 + HX_HCSTRING("openfl_aPosition","\x7b","\x19","\xf2","\xd0"));		HX_STACK_VAR(tmp11,"tmp11");
	HX_STACK_LINE(23)
	::String tmp12 = (tmp11 + HX_HCSTRING(", 1.0)).xy, 0.0, 1.0);","\x63","\x9b","\x3b","\x23"));		HX_STACK_VAR(tmp12,"tmp12");
	HX_STACK_LINE(24)
	::String tmp13 = (HX_HCSTRING("   vTexCoord = ","\x1f","\xae","\x6f","\x4a") + HX_HCSTRING("openfl_aTexCoord0","\x10","\x9c","\x05","\xd4"));		HX_STACK_VAR(tmp13,"tmp13");
	HX_STACK_LINE(24)
	::String tmp14 = (tmp13 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp14,"tmp14");
	HX_STACK_LINE(26)
	::String tmp15 = (HX_HCSTRING("   vColor = ","\x56","\x06","\xcb","\xfb") + HX_HCSTRING("openfl_aColor","\x51","\x21","\x0d","\xbc"));		HX_STACK_VAR(tmp15,"tmp15");
	HX_STACK_LINE(26)
	...
	HX_STACK_LINE(36)
	::String tmp17 = (HX_HCSTRING("uniform sampler2D ","\x72","\x47","\xf0","\xca") + HX_HCSTRING("openfl_uSampler0","\x0e","\x4f","\x96","\x4d"));		HX_STACK_VAR(tmp17,"tmp17");
	HX_STACK_LINE(36)
	::String tmp18 = (tmp17 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp18,"tmp18");
	HX_STACK_LINE(37)
	::String tmp19 = (HX_HCSTRING("uniform vec3 ","\xf5","\xf7","\xa8","\x3d") + HX_HCSTRING("openfl_uColor","\xbd","\x58","\x30","\xbb"));		HX_STACK_VAR(tmp19,"tmp19");
	HX_STACK_LINE(37)
	::String tmp20 = (tmp19 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp20,"tmp20");
	HX_STACK_LINE(38)
	::String tmp21 = (HX_HCSTRING("uniform bool ","\xca","\xcc","\x4a","\xc0") + HX_HCSTRING("openfl_uUseTexture","\xba","\x1d","\x59","\xc0"));		HX_STACK_VAR(tmp21,"tmp21");
	HX_STACK_LINE(38)
	::String tmp22 = (tmp21 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp22,"tmp22");
	HX_STACK_LINE(39)
	::String tmp23 = (HX_HCSTRING("uniform float ","\x70","\x08","\x5a","\x60") + HX_HCSTRING("openfl_uAlpha","\xb8","\x8e","\x6a","\x92"));		HX_STACK_VAR(tmp23,"tmp23");
	HX_STACK_LINE(39)
	::String tmp24 = (tmp23 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp24,"tmp24");
	HX_STACK_LINE(40)
	::String tmp25 = (HX_HCSTRING("uniform vec4 ","\xd4","\xf8","\xa8","\x3d") + HX_HCSTRING("openfl_uColorMultiplier","\x9e","\x72","\x0d","\x28"));		HX_STACK_VAR(tmp25,"tmp25");
	HX_STACK_LINE(40)
	::String tmp26 = (tmp25 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp26,"tmp26");
	HX_STACK_LINE(41)
	::String tmp27 = (HX_HCSTRING("uniform vec4 ","\xd4","\xf8","\xa8","\x3d") + HX_HCSTRING("openfl_uColorOffset","\x30","\x10","\x2f","\xe8"));		HX_STACK_VAR(tmp27,"tmp27");
	HX_STACK_LINE(41)
	::String tmp28 = (tmp27 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp28,"tmp28");
	HX_STACK_LINE(58)
	::String tmp29 = (HX_HCSTRING("   if(","\x8b","\xf5","\xb4","\x4d") + HX_HCSTRING("openfl_uUseTexture","\xba","\x1d","\x59","\xc0"));		HX_STACK_VAR(tmp29,"tmp29");
	HX_STACK_LINE(58)
	::String tmp30 = (tmp29 + HX_HCSTRING(") {","\xc4","\x38","\x1f","\x00"));		HX_STACK_VAR(tmp30,"tmp30");
	HX_STACK_LINE(59)
	::String tmp31 = (HX_HCSTRING("       tmp = texture2D(","\x27","\xe2","\xb6","\xea") + HX_HCSTRING("openfl_uSampler0","\x0e","\x4f","\x96","\x4d"));		HX_STACK_VAR(tmp31,"tmp31");
	HX_STACK_LINE(59)
	::String tmp32 = (tmp31 + HX_HCSTRING(", vTexCoord);","\xe2","\xd4","\xb7","\x35"));		HX_STACK_VAR(tmp32,"tmp32");
	HX_STACK_LINE(61)
	::String tmp33 = (HX_HCSTRING("       tmp = vec4(","\x3c","\x04","\xe2","\x12") + HX_HCSTRING("openfl_uColor","\xbd","\x58","\x30","\xbb"));		HX_STACK_VAR(tmp33,"tmp33");
	HX_STACK_LINE(61)
	::String tmp34 = (tmp33 + HX_HCSTRING(", 1.);","\x83","\xf0","\x0c","\x25"));		HX_STACK_VAR(tmp34,"tmp34");
	HX_STACK_LINE(63)
	::String tmp35 = (HX_HCSTRING("   gl_FragColor = colorTransform(tmp, vColor, ","\xb9","\x15","\x5b","\x44") + HX_HCSTRING("openfl_uColorMultiplier","\x9e","\x72","\x0d","\x28"));		HX_STACK_VAR(tmp35,"tmp35");
	HX_STACK_LINE(63)
	::String tmp36 = (tmp35 + HX_HCSTRING(", ","\x74","\x26","\x00","\x00"));		HX_STACK_VAR(tmp36,"tmp36");
	HX_STACK_LINE(63)
	::String tmp37 = (tmp36 + HX_HCSTRING("openfl_uColorOffset","\x30","\x10","\x2f","\xe8"));		HX_STACK_VAR(tmp37,"tmp37");
	HX_STACK_LINE(63)
	...
	HX_STACK_ARG(force,"force")
{
		...
		HX_STACK_LINE(79)
		this->getUniformLocation(HX_HCSTRING("openfl_uColor","\xbd","\x58","\x30","\xbb"));
		HX_STACK_LINE(80)
		this->getUniformLocation(HX_HCSTRING("openfl_uAlpha","\xb8","\x8e","\x6a","\x92"));
		HX_STACK_LINE(81)
		this->getUniformLocation(HX_HCSTRING("openfl_uUseTexture","\xba","\x1d","\x59","\xc0"));
		HX_STACK_LINE(82)
