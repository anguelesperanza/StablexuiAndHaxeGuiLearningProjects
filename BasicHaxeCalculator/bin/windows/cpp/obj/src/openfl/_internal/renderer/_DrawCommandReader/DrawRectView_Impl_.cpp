...
::openfl::_internal::renderer::DrawCommandReader DrawRectView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawRectView_Impl_","_new",0x5ddfb9ba,"openfl._internal.renderer._DrawCommandReader.DrawRectView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",341,0xbbdbd1ae)
	HX_STACK_ARG(d,"d")
	HX_STACK_LINE(341)
...
Float DrawRectView_Impl__obj::get_x( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawRectView_Impl_","get_x",0x5b2fced6,"openfl._internal.renderer._DrawCommandReader.DrawRectView_Impl_.get_x","openfl/_internal/renderer/DrawCommandReader.hx",342,0xbbdbd1ae)
...
Float DrawRectView_Impl__obj::get_y( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawRectView_Impl_","get_y",0x5b2fced7,"openfl._internal.renderer._DrawCommandReader.DrawRectView_Impl_.get_y","openfl/_internal/renderer/DrawCommandReader.hx",343,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(343)
...
Float DrawRectView_Impl__obj::get_width( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawRectView_Impl_","get_width",0x943c0b64,"openfl._internal.renderer._DrawCommandReader.DrawRectView_Impl_.get_width","openfl/_internal/renderer/DrawCommandReader.hx",344,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(344)
...
Float DrawRectView_Impl__obj::get_height( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawRectView_Impl_","get_height",0xd69d64c9,"openfl._internal.renderer._DrawCommandReader.DrawRectView_Impl_.get_height","openfl/_internal/renderer/DrawCommandReader.hx",345,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(345)
