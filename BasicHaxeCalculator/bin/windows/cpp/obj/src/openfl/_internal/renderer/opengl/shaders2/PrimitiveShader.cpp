...
HX_STACK_ARG(gl,"gl")
{
	...
	HX_STACK_LINE(14)
	::String tmp3 = (HX_HCSTRING("attribute vec4 ","\xbc","\x45","\xff","\xbe") + HX_HCSTRING("openfl_aColor","\x51","\x21","\x0d","\xbc"));		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(14)
	::String tmp4 = (tmp3 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(16)
	::String tmp5 = (HX_HCSTRING("uniform mat3 ","\x41","\xcb","\x75","\x0c") + HX_HCSTRING("openfl_uTranslationMatrix","\x6c","\x2c","\xb6","\x64"));		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(16)
	...
	HX_STACK_LINE(18)
	::String tmp9 = (HX_HCSTRING("uniform vec4 ","\xd4","\xf8","\xa8","\x3d") + HX_HCSTRING("openfl_uColorMultiplier","\x9e","\x72","\x0d","\x28"));		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(18)
	::String tmp10 = (tmp9 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp10,"tmp10");
	HX_STACK_LINE(19)
	::String tmp11 = (HX_HCSTRING("uniform vec4 ","\xd4","\xf8","\xa8","\x3d") + HX_HCSTRING("openfl_uColorOffset","\x30","\x10","\x2f","\xe8"));		HX_STACK_VAR(tmp11,"tmp11");
	HX_STACK_LINE(19)
	::String tmp12 = (tmp11 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp12,"tmp12");
	HX_STACK_LINE(20)
	::String tmp13 = (HX_HCSTRING("uniform float ","\x70","\x08","\x5a","\x60") + HX_HCSTRING("openfl_uAlpha","\xb8","\x8e","\x6a","\x92"));		HX_STACK_VAR(tmp13,"tmp13");
	HX_STACK_LINE(20)
	::String tmp14 = (tmp13 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp14,"tmp14");
	HX_STACK_LINE(34)
	::String tmp15 = (HX_HCSTRING("   gl_Position = vec4((","\x60","\xee","\x15","\xd9") + HX_HCSTRING("openfl_uProjectionMatrix","\x16","\x8b","\xff","\x93"));		HX_STACK_VAR(tmp15,"tmp15");
	HX_STACK_LINE(34)
	::String tmp16 = (tmp15 + HX_HCSTRING(" * ","\xd6","\x6c","\x18","\x00"));		HX_STACK_VAR(tmp16,"tmp16");
	HX_STACK_LINE(34)
	::String tmp17 = (tmp16 + HX_HCSTRING("openfl_uTranslationMatrix","\x6c","\x2c","\xb6","\x64"));		HX_STACK_VAR(tmp17,"tmp17");
	HX_STACK_LINE(34)
	::String tmp18 = (tmp17 + HX_HCSTRING(" * vec3(","\x53","\x97","\x95","\xf8"));		HX_STACK_VAR(tmp18,"tmp18");
	HX_STACK_LINE(34)
	::String tmp19 = (tmp18 + HX_HCSTRING("openfl_aPosition","\x7b","\x19","\xf2","\xd0"));		HX_STACK_VAR(tmp19,"tmp19");
	HX_STACK_LINE(34)
	::String tmp20 = (tmp19 + HX_HCSTRING(", 1.0)).xy, 0.0, 1.0);","\x63","\x9b","\x3b","\x23"));		HX_STACK_VAR(tmp20,"tmp20");
	HX_STACK_LINE(35)
	::String tmp21 = (HX_HCSTRING("   vColor = colorTransform(","\xe9","\x4a","\x56","\xf6") + HX_HCSTRING("openfl_aColor","\x51","\x21","\x0d","\xbc"));		HX_STACK_VAR(tmp21,"tmp21");
	HX_STACK_LINE(35)
	::String tmp22 = (tmp21 + HX_HCSTRING(", ","\x74","\x26","\x00","\x00"));		HX_STACK_VAR(tmp22,"tmp22");
	HX_STACK_LINE(35)
	::String tmp23 = (tmp22 + HX_HCSTRING("openfl_uAlpha","\xb8","\x8e","\x6a","\x92"));		HX_STACK_VAR(tmp23,"tmp23");
	HX_STACK_LINE(35)
	::String tmp24 = (tmp23 + HX_HCSTRING(", ","\x74","\x26","\x00","\x00"));		HX_STACK_VAR(tmp24,"tmp24");
	HX_STACK_LINE(35)
	::String tmp25 = (tmp24 + HX_HCSTRING("openfl_uColorMultiplier","\x9e","\x72","\x0d","\x28"));		HX_STACK_VAR(tmp25,"tmp25");
	HX_STACK_LINE(35)
	::String tmp26 = (tmp25 + HX_HCSTRING(", ","\x74","\x26","\x00","\x00"));		HX_STACK_VAR(tmp26,"tmp26");
	HX_STACK_LINE(35)
	::String tmp27 = (tmp26 + HX_HCSTRING("openfl_uColorOffset","\x30","\x10","\x2f","\xe8"));		HX_STACK_VAR(tmp27,"tmp27");
	HX_STACK_LINE(35)
...
{  hx::ObjectPtr< PrimitiveShader_obj > _result_ = new PrimitiveShader_obj();
...
Dynamic PrimitiveShader_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
