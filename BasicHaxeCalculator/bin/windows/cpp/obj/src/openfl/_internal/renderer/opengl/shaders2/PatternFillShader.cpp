...
HX_STACK_ARG(gl,"gl")
{
	...
	HX_STACK_LINE(13)
	::String tmp1 = (HX_HCSTRING("attribute vec2 ","\xfe","\x43","\xff","\xbe") + HX_HCSTRING("openfl_aPosition","\x7b","\x19","\xf2","\xd0"));		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(13)
	::String tmp2 = (tmp1 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(14)
	::String tmp3 = (HX_HCSTRING("uniform mat3 ","\x41","\xcb","\x75","\x0c") + HX_HCSTRING("openfl_uTranslationMatrix","\x6c","\x2c","\xb6","\x64"));		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(14)
	::String tmp4 = (tmp3 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(15)
	::String tmp5 = (HX_HCSTRING("uniform mat3 ","\x41","\xcb","\x75","\x0c") + HX_HCSTRING("openfl_uProjectionMatrix","\x16","\x8b","\xff","\x93"));		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(15)
	::String tmp6 = (tmp5 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(16)
	::String tmp7 = (HX_HCSTRING("uniform mat3 ","\x41","\xcb","\x75","\x0c") + HX_HCSTRING("openfl_uPatternMatrix","\x0b","\x1e","\x03","\x6f"));		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(16)
	::String tmp8 = (tmp7 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(21)
	::String tmp9 = (HX_HCSTRING("   gl_Position = vec4((","\x60","\xee","\x15","\xd9") + HX_HCSTRING("openfl_uProjectionMatrix","\x16","\x8b","\xff","\x93"));		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(21)
	::String tmp10 = (tmp9 + HX_HCSTRING(" * ","\xd6","\x6c","\x18","\x00"));		HX_STACK_VAR(tmp10,"tmp10");
	HX_STACK_LINE(21)
	::String tmp11 = (tmp10 + HX_HCSTRING("openfl_uTranslationMatrix","\x6c","\x2c","\xb6","\x64"));		HX_STACK_VAR(tmp11,"tmp11");
	HX_STACK_LINE(21)
	::String tmp12 = (tmp11 + HX_HCSTRING(" * vec3(","\x53","\x97","\x95","\xf8"));		HX_STACK_VAR(tmp12,"tmp12");
	HX_STACK_LINE(21)
	::String tmp13 = (tmp12 + HX_HCSTRING("openfl_aPosition","\x7b","\x19","\xf2","\xd0"));		HX_STACK_VAR(tmp13,"tmp13");
	HX_STACK_LINE(21)
	::String tmp14 = (tmp13 + HX_HCSTRING(", 1.0)).xy, 0.0, 1.0);","\x63","\x9b","\x3b","\x23"));		HX_STACK_VAR(tmp14,"tmp14");
	HX_STACK_LINE(22)
	::String tmp15 = (HX_HCSTRING("   vPosition = (","\x04","\x90","\xc7","\x1a") + HX_HCSTRING("openfl_uPatternMatrix","\x0b","\x1e","\x03","\x6f"));		HX_STACK_VAR(tmp15,"tmp15");
	HX_STACK_LINE(22)
	::String tmp16 = (tmp15 + HX_HCSTRING(" * vec3(","\x53","\x97","\x95","\xf8"));		HX_STACK_VAR(tmp16,"tmp16");
	HX_STACK_LINE(22)
	::String tmp17 = (tmp16 + HX_HCSTRING("openfl_aPosition","\x7b","\x19","\xf2","\xd0"));		HX_STACK_VAR(tmp17,"tmp17");
	HX_STACK_LINE(22)
	...
	HX_STACK_LINE(32)
	::String tmp19 = (HX_HCSTRING("uniform float ","\x70","\x08","\x5a","\x60") + HX_HCSTRING("openfl_uAlpha","\xb8","\x8e","\x6a","\x92"));		HX_STACK_VAR(tmp19,"tmp19");
	HX_STACK_LINE(32)
	::String tmp20 = (tmp19 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp20,"tmp20");
	HX_STACK_LINE(33)
	::String tmp21 = (HX_HCSTRING("uniform vec2 ","\x16","\xf7","\xa8","\x3d") + HX_HCSTRING("openfl_uPatternTL","\x22","\x20","\x65","\xda"));		HX_STACK_VAR(tmp21,"tmp21");
	HX_STACK_LINE(33)
	::String tmp22 = (tmp21 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp22,"tmp22");
	HX_STACK_LINE(34)
	::String tmp23 = (HX_HCSTRING("uniform vec2 ","\x16","\xf7","\xa8","\x3d") + HX_HCSTRING("openfl_uPatternBR","\x7a","\x10","\x65","\xda"));		HX_STACK_VAR(tmp23,"tmp23");
	HX_STACK_LINE(34)
	::String tmp24 = (tmp23 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp24,"tmp24");
	HX_STACK_LINE(35)
	::String tmp25 = (HX_HCSTRING("uniform sampler2D ","\x72","\x47","\xf0","\xca") + HX_HCSTRING("openfl_uSampler0","\x0e","\x4f","\x96","\x4d"));		HX_STACK_VAR(tmp25,"tmp25");
	HX_STACK_LINE(35)
	::String tmp26 = (tmp25 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp26,"tmp26");
	HX_STACK_LINE(37)
	::String tmp27 = (HX_HCSTRING("uniform vec4 ","\xd4","\xf8","\xa8","\x3d") + HX_HCSTRING("openfl_uColorMultiplier","\x9e","\x72","\x0d","\x28"));		HX_STACK_VAR(tmp27,"tmp27");
	HX_STACK_LINE(37)
	::String tmp28 = (tmp27 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp28,"tmp28");
	HX_STACK_LINE(38)
	::String tmp29 = (HX_HCSTRING("uniform vec4 ","\xd4","\xf8","\xa8","\x3d") + HX_HCSTRING("openfl_uColorOffset","\x30","\x10","\x2f","\xe8"));		HX_STACK_VAR(tmp29,"tmp29");
	HX_STACK_LINE(38)
	::String tmp30 = (tmp29 + HX_HCSTRING(";","\x3b","\x00","\x00","\x00"));		HX_STACK_VAR(tmp30,"tmp30");
	HX_STACK_LINE(53)
	::String tmp31 = (HX_HCSTRING("   vec2 pos = mix(","\x3d","\x20","\x89","\x8c") + HX_HCSTRING("openfl_uPatternTL","\x22","\x20","\x65","\xda"));		HX_STACK_VAR(tmp31,"tmp31");
	HX_STACK_LINE(53)
	::String tmp32 = (tmp31 + HX_HCSTRING(", ","\x74","\x26","\x00","\x00"));		HX_STACK_VAR(tmp32,"tmp32");
	HX_STACK_LINE(53)
	::String tmp33 = (tmp32 + HX_HCSTRING("openfl_uPatternBR","\x7a","\x10","\x65","\xda"));		HX_STACK_VAR(tmp33,"tmp33");
	HX_STACK_LINE(53)
	::String tmp34 = (tmp33 + HX_HCSTRING(", vPosition);","\xfd","\xba","\x9c","\x09"));		HX_STACK_VAR(tmp34,"tmp34");
	HX_STACK_LINE(54)
	::String tmp35 = (HX_HCSTRING("   vec4 tcol = texture2D(","\xd2","\xac","\x26","\xf7") + HX_HCSTRING("openfl_uSampler0","\x0e","\x4f","\x96","\x4d"));		HX_STACK_VAR(tmp35,"tmp35");
	HX_STACK_LINE(54)
	::String tmp36 = (tmp35 + HX_HCSTRING(", pos);","\x92","\x03","\xb3","\xb7"));		HX_STACK_VAR(tmp36,"tmp36");
	HX_STACK_LINE(55)
	::String tmp37 = (HX_HCSTRING("   gl_FragColor = colorTransform(tcol, ","\x33","\x4b","\xb4","\xf6") + HX_HCSTRING("openfl_uAlpha","\xb8","\x8e","\x6a","\x92"));		HX_STACK_VAR(tmp37,"tmp37");
	HX_STACK_LINE(55)
	::String tmp38 = (tmp37 + HX_HCSTRING(", ","\x74","\x26","\x00","\x00"));		HX_STACK_VAR(tmp38,"tmp38");
	HX_STACK_LINE(55)
	::String tmp39 = (tmp38 + HX_HCSTRING("openfl_uColorMultiplier","\x9e","\x72","\x0d","\x28"));		HX_STACK_VAR(tmp39,"tmp39");
	HX_STACK_LINE(55)
	::String tmp40 = (tmp39 + HX_HCSTRING(", ","\x74","\x26","\x00","\x00"));		HX_STACK_VAR(tmp40,"tmp40");
	HX_STACK_LINE(55)
	::String tmp41 = (tmp40 + HX_HCSTRING("openfl_uColorOffset","\x30","\x10","\x2f","\xe8"));		HX_STACK_VAR(tmp41,"tmp41");
	HX_STACK_LINE(55)
	...
	HX_STACK_ARG(force,"force")
{
		...
		HX_STACK_LINE(67)
		this->getUniformLocation(HX_HCSTRING("openfl_uTranslationMatrix","\x6c","\x2c","\xb6","\x64"));
		HX_STACK_LINE(68)
		this->getUniformLocation(HX_HCSTRING("openfl_uPatternMatrix","\x0b","\x1e","\x03","\x6f"));
		HX_STACK_LINE(69)
		...
		HX_STACK_LINE(71)
		this->getUniformLocation(HX_HCSTRING("openfl_uPatternTL","\x22","\x20","\x65","\xda"));
		HX_STACK_LINE(72)
		this->getUniformLocation(HX_HCSTRING("openfl_uPatternBR","\x7a","\x10","\x65","\xda"));
		HX_STACK_LINE(73)
		this->getUniformLocation(HX_HCSTRING("openfl_uAlpha","\xb8","\x8e","\x6a","\x92"));
		HX_STACK_LINE(74)
