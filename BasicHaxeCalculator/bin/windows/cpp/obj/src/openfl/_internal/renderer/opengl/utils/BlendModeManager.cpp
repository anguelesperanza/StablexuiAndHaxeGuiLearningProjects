	...
	HX_STACK_ARG(force,"force")
{
		...
		if ((tmp3)){
			HX_STACK_LINE(39)
			Dynamic tmp5 = this->currentBlendMode;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(39)
			Dynamic tmp6 = tmp5;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(39)
			Dynamic tmp7 = blendMode;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(39)
			tmp4 = (tmp6 == tmp7);
		}
		else{
		...
		HX_STACK_LINE(47)
		Dynamic tmp5 = blendMode;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(47)
		switch( (int)(tmp5)){
			case (int)0: {
				HX_STACK_LINE(51)
