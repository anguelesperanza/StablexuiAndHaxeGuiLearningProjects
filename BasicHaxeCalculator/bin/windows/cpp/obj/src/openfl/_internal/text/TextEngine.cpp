				...
				if ((tmp17)){
					...
					while((true)){
						...
						if ((tmp21)){
							...
							if ((tmp23)){
								HX_STACK_LINE(878)
								Dynamic tmp24 = formatRange->format->align;		HX_STACK_VAR(tmp24,"tmp24");
								HX_STACK_LINE(878)
								bool tmp25 = (tmp24 != ((Dynamic)((int)2)));		HX_STACK_VAR(tmp25,"tmp25");
								HX_STACK_LINE(878)
								if ((tmp25)){
									HX_STACK_LINE(880)
								...
								if ((tmp25)){
									HX_STACK_LINE(887)
									tmp26 = (lineFormat->align == ((Dynamic)((int)2)));
								}
								else{
									HX_STACK_LINE(887)
									tmp26 = true;
							...
							case (int)2: {
								...
								if ((tmp11)){
									...
									if ((tmp12)){
										...
										group = tmp15;
										HX_STACK_LINE(1036)
										int tmp16 = group->endIndex;		HX_STACK_VAR(tmp16,"tmp16");
										HX_STACK_LINE(1036)
										...
										if ((tmp19)){
											...
											HX_STACK_LINE(1036)
											int tmp23 = group->endIndex;		HX_STACK_VAR(tmp23,"tmp23");
											HX_STACK_LINE(1036)
											int tmp24 = tmp23;		HX_STACK_VAR(tmp24,"tmp24");
											HX_STACK_LINE(1036)
											::String tmp25 = tmp22.charAt(tmp24);		HX_STACK_VAR(tmp25,"tmp25");
											HX_STACK_LINE(1036)
											::String tmp26 = tmp25;		HX_STACK_VAR(tmp26,"tmp26");
											HX_STACK_LINE(1036)
											tmp20 = (tmp26 != HX_HCSTRING("\n","\x0a","\x00","\x00","\x00"));
										}
										else{
											HX_STACK_LINE(1036)
											tmp20 = false;
										...
										if ((tmp20)){
											...
											HX_STACK_LINE(1038)
											Float tmp23 = this->lineWidths->__get(lineIndex);		HX_STACK_VAR(tmp23,"tmp23");
											HX_STACK_LINE(1038)
											Float tmp24 = (tmp22 - tmp23);		HX_STACK_VAR(tmp24,"tmp24");
											HX_STACK_LINE(1038)
											int tmp25 = (lineLength - (int)1);		HX_STACK_VAR(tmp25,"tmp25");
											HX_STACK_LINE(1038)
											...
											HX_STACK_LINE(1040)
											{
												...
												while((true)){
													HX_STACK_LINE(1040)
													bool tmp27 = (_g3 < lineLength);		HX_STACK_VAR(tmp27,"tmp27");
													HX_STACK_LINE(1040)
													bool tmp28 = !(tmp27);		HX_STACK_VAR(tmp28,"tmp28");
													HX_STACK_LINE(1040)
													if ((tmp28)){
													...
													HX_STACK_LINE(1042)
													Float tmp30 = (offsetX * j);		HX_STACK_VAR(tmp30,"tmp30");
													HX_STACK_LINE(1042)
													int tmp31 = (i + j);		HX_STACK_VAR(tmp31,"tmp31");
													HX_STACK_LINE(1042)
													::openfl::_internal::text::TextLayoutGroup tmp32 = this->layoutGroups->__get(tmp31).StaticCast< ::openfl::_internal::text::TextLayoutGroup >();		HX_STACK_VAR(tmp32,"tmp32");
													HX_STACK_LINE(1042)
													hx::AddEq(tmp32->offsetX,tmp30);
												}
											}
										}
									}
