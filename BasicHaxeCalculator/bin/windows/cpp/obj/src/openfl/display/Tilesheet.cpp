...
{
HX_STACK_FRAME("openfl.display.Tilesheet","new",0x93eb2f79,"openfl.display.Tilesheet.new","openfl/display/Tilesheet.hx",61,0x2fc30619)
HX_STACK_THIS(this)
...
int Tilesheet_obj::addTileRect( ::openfl::geom::Rectangle rectangle,::openfl::geom::Point centerPoint){
	HX_STACK_FRAME("openfl.display.Tilesheet","addTileRect",0x692b4acc,"openfl.display.Tilesheet.addTileRect","openfl/display/Tilesheet.hx",89,0x2fc30619)
	HX_STACK_THIS(this)
...
int count = __o_count.Default(-1);
	HX_STACK_FRAME("openfl.display.Tilesheet","drawTiles",0x3dc16aba,"openfl.display.Tilesheet.drawTiles","openfl/display/Tilesheet.hx",193,0x2fc30619)
	HX_STACK_THIS(this)
...
::openfl::geom::Point Tilesheet_obj::getTileCenter( int index){
	HX_STACK_FRAME("openfl.display.Tilesheet","getTileCenter",0x7cc0f032,"openfl.display.Tilesheet.getTileCenter","openfl/display/Tilesheet.hx",199,0x2fc30619)
	HX_STACK_THIS(this)
...
::openfl::geom::Rectangle Tilesheet_obj::getTileRect( int index){
	HX_STACK_FRAME("openfl.display.Tilesheet","getTileRect",0x5dc2d641,"openfl.display.Tilesheet.getTileRect","openfl/display/Tilesheet.hx",206,0x2fc30619)
	HX_STACK_THIS(this)
	HX_STACK_ARG(index,"index")
	HX_STACK_LINE(208)
...
::openfl::geom::Rectangle Tilesheet_obj::getTileUVs( int index){
	HX_STACK_FRAME("openfl.display.Tilesheet","getTileUVs",0x006ddc95,"openfl.display.Tilesheet.getTileUVs","openfl/display/Tilesheet.hx",213,0x2fc30619)
	HX_STACK_THIS(this)
	HX_STACK_ARG(index,"index")
	HX_STACK_LINE(215)
