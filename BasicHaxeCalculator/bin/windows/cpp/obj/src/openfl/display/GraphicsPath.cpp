...
Void GraphicsPath_obj::__construct(Array< int > commands,Array< Float > data,::String winding)
{
...
HX_STACK_ARG(winding,"winding")
{
	...
	if ((tmp)){
		HX_STACK_LINE(22)
		winding = HX_HCSTRING("evenOdd","\xb5","\xc6","\x7e","\x06");
	}
	HX_STACK_LINE(26)
...
hx::ObjectPtr< GraphicsPath_obj > GraphicsPath_obj::__new(Array< int > commands,Array< Float > data,::String winding)
...
Dynamic GraphicsPath_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"winding") ) { winding=inValue.Cast< ::String >(); return inValue; }
		break;
	case 8:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsString,(int)offsetof(GraphicsPath_obj,winding),HX_HCSTRING("winding","\x1a","\x49","\x70","\xe8")},
