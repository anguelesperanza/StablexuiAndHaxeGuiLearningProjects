...
class ApplicationMain {
	...
	public static function main () {
		...
		config = {
			...
			build: "228",
			company: "Anguel Esperanza",
			file: "BasicHaxeCalculator",
			fps: 60,
			name: "BasicHaxeCalculator",
			orientation: "",
			packageName: "BasicHaxeCalculator",
			version: "1.0.0",
			windows: [
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 300, 300, "FFFFFF");
		#end
		#else
		create ();
		#end
